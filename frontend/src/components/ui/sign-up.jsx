          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="p-0 relative z-10">
              ...
              <p className="text-center text-gray-500 mt-2">
                Sign up to register your details
              </p>
            </div>
          </div>

          <div className="space-y-5 p-0 relative z-10">
            <div className="space-y-1">
              ...
              <input
                type="text"
                className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 h-11 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500/50 focus:border-blue-500 w-full px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="bg-gray-50 border-gray-200 text-gray-900 pr-12 h-11 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500/50 focus:border-blue-500 w-full px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button className="w-full h-11 bg-gradient-to-t from-blue-600 via-blue-500 to-blue-400 hover:from-blue-700 hover:via-blue-600 hover:to-blue-500 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md hover:shadow-blue-100 active:scale-[0.98] inline-flex items-center justify-center whitespace-nowrap text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
              Sign Up
            </button>

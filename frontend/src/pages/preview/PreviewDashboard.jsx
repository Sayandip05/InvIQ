        ...
        <div className="flex h-screen w-screen bg-background font-sans text-foreground overflow-hidden">
            ...
            {showHelp && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
                    <div className="bg-card border border-border w-full max-w-md p-6 shadow-2xl space-y-4 rounded-xl text-card-foreground">
                        ...
                        <div className="pt-2">
                            <button
                                onClick={() => setShowHelp(false)}
                                className="w-full py-2.5 bg-primary hover:bg-black text-primary-foreground font-semibold text-sm rounded-md transition-colors cursor-pointer"
                            >
                                OK, Got It
                            </button>
                        </div>
                        ...
                        <div className="space-y-6 max-w-7xl mx-auto">
                            ...
                            <div className="bg-card border border-border rounded-xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-border shadow-xs">
                                <div className="p-6 flex flex-col justify-between">
                                    <div>
                                        <p className="text-xs font-semibold text-muted-foreground tracking-wider font-mono">Total Medicines</p>
                            ...
                            <div className="bg-card border border-border rounded-xl grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border shadow-xs">
                                ...
                                <div className="p-6 flex flex-col justify-between">
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-xs font-semibold text-foreground bg-accent px-2 py-0.5 border border-border rounded-md flex items-center gap-0.5 font-mono">
                                ...
                                <div className="p-6 flex flex-col justify-between">
                                    <ExpiryLineChart data={MOCK_STATS.expiry_timeline} height={240} />
                                </div>
                            </div>
                            ...
                            <div className="bg-card border border-border rounded-xl shadow-xs overflow-hidden">
                                <div className="p-4 border-b border-border flex items-center justify-between bg-accent/40">
                                    ...
                                    <span className="text-xs font-semibold text-white bg-[#F26A4B] px-2.5 py-1 rounded-md font-mono">
                                ...
                                <div className="divide-y divide-border">
                                    {MOCK_STATS.low_stock_items.map((item) => (
                                        <div key={item.id} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:bg-accent/30 transition-colors">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 bg-[#F26A4B]/10 text-[#F26A4B] border border-[#F26A4B]/30 flex items-center justify-center font-bold text-sm rounded-md">
                                                    !
                                                </div>
                                                <div>
                                                    ...
                                                    <p className="text-xs text-muted-foreground flex items-center gap-1.5 mt-0.5">
                                                        ...
                                                        <span>•</span>
                                                        <span className="text-foreground font-medium">{formatCategory(item.category)}</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-4">
                                                ...
                                                <button
                                                    onClick={() => navigate('/signin')}
                                                    className="px-3 py-1.5 text-xs font-semibold text-foreground bg-accent hover:bg-primary hover:text-primary-foreground border border-border rounded-md transition-colors cursor-pointer"
                                                >
                                                    Auto-Restock →
                                                </button>
                                            </div>
                                        ...
                                        <tbody className="divide-y divide-border text-foreground">
                                            {filteredItems.map(item => (
                                                <tr key={item.id} className="hover:bg-accent/30 transition-colors">
                                                    ...
                                                    <td className="py-3.5 px-5">{formatCategory(item.category)}</td>
                                                    <td className="py-3.5 px-5">
                                                        {item.storage_temp === 'cold_chain' ? (
                                                            <span className="inline-flex items-center gap-1 text-xs font-bold text-primary bg-accent px-2 py-0.5 rounded-md border border-border">
                                                                ❄️ Fridge (2°–8°C)
                                                            </span>
                                                        ) : (
